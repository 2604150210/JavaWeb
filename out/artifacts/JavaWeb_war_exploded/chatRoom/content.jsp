...
<%
    ...
    if (message!=null&&tempuser!=null){
        if (message.startsWith("<")){
            out.print("<marquee direction = 'left' scrollamount='23'>"+"<font color='blue'>"+"请不要输入带有标记的特殊符号"+"</font>"+"</marquee>");
            return;
        }else if(message.endsWith(">")){
            out.print("<marquee direction = 'right' scrollamount='25'>"+"<font color='blue'>"+"请不要输入带有标记的特殊符号"+"</font>"+"</marquee>");
            return;
        }
        if (application.getAttribute("message") == null){//第一个人说话
            application.setAttribute("message","<br>"+"<font color='blue'>" +
                    "<strong>"+session.getAttribute("username")+"</strong>"+"</font>"+
                    "<font color='#CC0000'>"+select+"</font>"+"对"+"<font color='green'>"+
                    "["+tempuser+"]"+"</font>"+"说： " + "<font color=>" +color+">"+message);
        }else {
            application.setAttribute("message","<br>"+"<font color='blue'>" +
                    "<strong>"+session.getAttribute("username")+"</strong>"+"</font>"+
                    "<font color='#CC0000'>"+select+"</font>"+"对"+"<font color='green'>"+
        ...
        if (application.getAttribute("message") == null){
            ...
            out.println("<br>"+"<center>"+"<font color='#aa0000'>"+"请各位聊友注意聊天室规则，不要在本聊天室内发表反动言论以及对他人进行人身攻击，不要随意刷屏。"+"</font>"+"</center>");
        }else {
